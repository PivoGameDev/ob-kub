...
<title>Винодельческое оборудование — полный каталог | ОБОРУДОВАНИЕ КУБАНИ</title>
    <link rel="canonical" href="https://ob-kub.ru/winery.html">
<meta name="description" content="Производство винодельческого оборудования из нержавеющей стали AISI 304/316. Ферментационные танки, винификаторы, ёмкости для выдержки и хранения вина. Доставка по РФ.">
...
<img src="wine-equipment.jpg" alt="Винодельческое оборудование" class="db-hero-bg">
<div class="db-hero-overlay"></div>
<div class="db-hero-inner">
<div class="db-hero-label">Оборудование Кубани — с 2008 года</div>
<h1>Винодельческое оборудование из нержавеющей стали</h1>
<p>Ферментационные танки, винификаторы, ёмкости для выдержки и хранения — полный цикл оснащения винодельческих производств.</p>
<div class="db-hero-stats">
<div class="db-hero-stat"><div class="num">70+</div><div class="lbl">Виноделен запущено</div></div>
...
<h2 class="db-section-title">Винодельни, которые мы запустили</h2>
<p class="db-section-sub">Реализованные проекты для винодельческих хозяйств по всей России и СНГ</p>
<div class="db-projects-scroll">
<div class="db-project-card">
<img src="wine-equipment-1.jpg" alt="Ферментационное оборудование" loading="lazy">
<div class="db-project-body">
<h3>Винодельня в Краснодарском крае</h3>
...
<p>Оснащение винодельни в Краснодарском крае полным циклом оборудования для приёмки, брожения, выдержки и стабилизации вина. Проект реализован за 12 недель.</p>
<ul>
<li>Танки для ферментации красных вин 5000 л × 4 шт. с рубашкой и ремонтажем</li>
<li>Танки для ферментации белых вин 3000 л × 3 шт. с криостатированием</li>
<li>Система инертизации азотом с генератором N₂</li>
<li>Ёмкости для хранения и выдержки 10 000 л × 6 шт.</li>
<li>Холодильная станция 150 кВт</li>
</ul>
<p><strong>Результат:</strong> 5 сортов вин, 70+ баллов по международной шкале, мощность 200 000 бутылок в год.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
<div class="db-project-card">
<img src="wine-equipment-2.jpg" alt="Танки для выдержки и стабилизации" loading="lazy">
<div class="db-project-body">
<h3>Линия холодной стабилизации, Крым</h3>
<div class="db-project-preview">
<ul><li>Ёмкости для холодной стабилизации</li><li>Система криостатирования</li><li>Автоматический контроль температуры</li></ul>
<button class="db-project-btn js-toggle-case">Читать кейс</button>
</div>
<div class="db-project-details">
<p>Специализированная линия холодной стабилизации для крупного винодельческого хозяйства в Крыму. Обеспечивает кристальную прозрачность вин перед розливом.</p>
<ul>
<li>Криостаты 6000 л × 3 шт. с охлаждением до -4°C</li>
<li>Система рециркуляции с точным термоконтролем</li>
<li>Фильтр-прессы для отделения винного камня</li>
<li>Автоматическая CIP-мойка танков</li>
<li>ПЛК с программируемыми профилями стабилизации</li>
</ul>
<p><strong>Результат:</strong> стабильное качество розлива, удаление тартратов без потери вкуса, производительность 100 000 дал/год.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
<div class="db-project-card">
<img src="wine-equipment-3.jpg" alt="Винодельня полного цикла" loading="lazy">
<div class="db-project-body">
<h3>Винодельня полного цикла, Ставрополье</h3>
<div class="db-project-preview">
<ul><li>От приёмки винограда до розлива</li><li>Бродильный цех + погреб выдержки</li><li>Автоматизация на базе Siemens</li></ul>
<button class="db-project-btn js-toggle-case">Читать кейс</button>
</div>
<div class="db-project-details">
<p>Винодельня полного цикла «под ключ» — от приёмки винограда до розлага готового вина. Проект включал строительство бродильного цеха, погреба выдержки и линии розлага.</p>
<ul>
<li>Линия приёмки винограда: бункер, гребнеотделитель, дробилка, насос</li>
<li>Танки для ферментации 10 000 л × 8 шт. с рубашками</li>
<li>Погреб выдержки: дубовые бочки + ёмкости из нержавейки 5000 л</li>
<li>Линия розлага 3000 бут/час</li>
<li>АСУ ТП на базе Siemens S7-1500</li>
</ul>
<p><strong>Результат:</strong> запуск за 16 недель, мощность 500 000 бутылок/год, 7 сортов вина.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
...
<div class="db-wrap">
<div class="db-section-line"></div>
<h2 class="db-section-title">Полный каталог винодельческого оборудования</h2>
<p class="db-section-sub">7 основных типов оборудования для профессионального виноделия. Все аппараты из пищевой нержавеющей стали AISI 304/316.</p>
<div class="cat-grid">
<a href="/catalog/wine/red-fermentation/" class="cat-card">
<div class="cat-card-img"><img src="wine-red-fermentation.jpg" alt="Ферментация красных вин" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Ферментация красных вин</div>
<div class="cat-desc">Танки для брожения красных сортов винограда. Рубашка охлаждения, система ремонтажа, датчики температуры и CO2.</div>
<div class="cat-count">9 объёмов — 500–50 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/white-fermentation/" class="cat-card">
<div class="cat-card-img"><img src="wine-white-fermentation.jpg" alt="Ферментация белых вин" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Ферментация белых вин</div>
<div class="cat-desc">Танки для брожения белых сортов при контролируемой температуре. Рубашка охлаждения, защитная газовая среда.</div>
<div class="cat-count">9 объёмов — 500–50 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/storage-aging/" class="cat-card">
<div class="cat-card-img"><img src="wine-storage-aging.jpg" alt="Выдержка и хранение" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Выдержка и хранение вина</div>
<div class="cat-desc">Ёмкости для дозревания и длительного хранения. Дубовые вставки, рубашки охлаждения, система азотной продувки.</div>
<div class="cat-count">10 объёмов — 1000–200 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/cold-stabilization/" class="cat-card">
<div class="cat-card-img"><img src="wine-cold-stabilization.jpg" alt="Холодная стабилизация" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Холодная стабилизация (криостат)</div>
<div class="cat-desc">Танки для криостабилизации вина. Интенсивное охлаждение до -4°C, выпадение винного камня, точный термоконтроль.</div>
<div class="cat-count">7 объёмов — 1000–30 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/blending/" class="cat-card">
<div class="cat-card-img"><img src="wine-blending.png" alt="Купажирование" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Купажирование вина</div>
<div class="cat-desc">Ёмкости для смешивания вин разных партий и сортов. Мешалка, пробоотборники, система учёта компонентов.</div>
<div class="cat-count">7 объёмов — 1000–50 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/sulfitation/" class="cat-card">
<div class="cat-card-img"><img src="wine-sulfitation.jpg" alt="Сульфитация" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Сульфитация вина</div>
<div class="cat-desc">Ёмкости для внесения сернистого ангидрида. Система дозирования SO2, контроль уровня, герметичная крышка.</div>
<div class="cat-count">7 объёмов — 1000–30 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/wine/universal-tank/" class="cat-card">
<div class="cat-card-img"><img src="wine-universal-tank.jpg" alt="Винификатор" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Винификатор (УТТ)</div>
<div class="cat-desc">Универсальный терморегулируемый танк для полного цикла: брожение, малолактика, выдержка. Всё в одном аппарате.</div>
<div class="cat-count">9 объёмов — 500–50 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
...
<p>На всё оборудование — официальная гарантия производителя. Сертификат ТР ЕАЭС на все виды продукции.</p>
</div>
<div class="db-adv-card">
<div class="icon-wrap"><img src="icon-project.svg" alt="Индивидуальное проектирование"></div>
<h3>Индивидуальное проектирование</h3>
<p>Разрабатываем концепцию под вашу винодельню, планировку цеха и бюджет. Любые нестандартные решения.</p>
</div>
<div class="db-adv-card">
...
<p class="db-section-sub">Ответы на основные вопросы о винодельческом оборудовании</p>
<div class="db-faq">
<div class="db-faq-item open">
<button class="db-faq-q" onclick="toggleFaq(this)">Какие танки нужны для оснащения винодельни?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Для полного цикла потребуются: ферментационные танки для брожения (красные/белые), ёмкости для выдержки и хранения, криостаты для холодной стабилизации, винификаторы, купажные ёмкости и системы сульфитации. Мы помогаем подобрать комплект под объём и технологию.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Делаете ли ёмкости с рубашкой охлаждения?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Да, все ферментационные танки и винификаторы комплектуются рубашками охлаждения для точного контроля температуры брожения. Возможны 1-3 независимые зоны охлаждения в зависимости от объёма и задачи.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Какой срок изготовления оборудования?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Стандартный срок — от 4 до 8 недель в зависимости от сложности и объёма заказа. Возможно ускоренное изготовление за 3-4 недели для типовых позиций.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Доставляете оборудование по всей России?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Да, доставляем во все регионы РФ — от Краснодара до Владивостока. Отгрузка любой транспортной компанией или собственным транспортом. Возможен шеф-монтаж на объекте.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Какая сталь используется для винодельческих танков?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Основной материал — AISI 304 с внутренней полировкой Ra ≤ 0.8 мкм. Для специальных задач (малолактика, длительная выдержка) рекомендуем AISI 316L. Толщина стенки — от 2 до 6 мм в зависимости от объёма.</p></div>
</div>
</div>
</div>
</section>
...
<input type="hidden" name="csrf" id="csrfToken" value=""><input type="hidden" name="form_type" value="wine-draft">
...
<option value="red_fermenter">Ферментационная ёмкость для красных вин</option>
<option value="white_fermenter">Ферментационный танк для белых вин</option>
<option value="aging">Цистерна для выдержки и хранения вина</option>
<option value="cryostat">Танк холодной стабилизации (Криостат)</option>
<option value="blending">Емкость для купажирования</option>
<option value="universal" selected>Винификатор</option>
</select>
</div>
...
<button type="button" class="db-vol-btn active" data-vol="2000" onclick="selectDraftVol(2000)">2 000</button>
...
<input type="hidden" id="draft-volume" name="volume" value="2000">
</div>

<div class="db-price-block" id="draft-price-block">
<div class="db-price-label">Предварительная стоимость:</div>
<div class="db-price-value" id="draft-price-value">от 1 075 000 ₽</div>
...
<a href="/catalog/wine/universal-tank/" class="sbtn catalog-link-btn" id="draft-catalog-link" target="_blank" style="display:inline-block; margin-top:8px; text-align:center; text-decoration:none; background:transparent; border:2px solid rgba(247,124,42,.3); color:#F77C2A; padding:13px; border-radius:10px; font-size:14px; font-weight:600;">Смотреть в каталоге →</a>
</form>
</div>
</section>
...
wine:{defaultPrices:{500:350000,1000:600000,2000:1000000,3000:1400000,5000:2200000,10000:3800000},types:[{value:'red_fermenter',label:'Ферментационная ёмкость для красных вин',prices:{500:280000,1000:480000,2000:800000,3000:1100000,5000:1700000,10000:2900000}},{value:'white_fermenter',label:'Ферментационный танк для белых вин',prices:{500:300000,1000:500000,2000:850000,3000:1200000,5000:1800000,10000:3100000}},{value:'aging',label:'Цистерна для выдержки и хранения вина',prices:{1000:350000,2000:550000,3000:750000,5000:1100000,10000:2000000}},{value:'cryostat',label:'Танк холодной стабилизации (Криостат)',prices:{500:350000,1000:600000,2000:950000,3000:1300000,5000:2000000,10000:3400000}},{value:'blending',label:'Емкость для купажирования',prices:{1000:450000,2000:730000,3000:1000000,5000:1500000,10000:2600000}},{value:'universal',label:'Винификатор',prices:{500:380000,1000:650000,2000:1075000,3000:1500000,5000:2300000,10000:3800000}}]}
};
var catalogUrls={
