...
<title>Политика конфиденциальности — ОБОРУДОВАНИЕ КУБАНИ</title>
<meta name="description" content="Политика обработки персональных данных ООО «Оборудование Кубани».">
<link rel="canonical" href="https://ob-kub.ru/privacy.html">
...
.header .logo-img{height:73px!important;width:auto!important;display:block!important}
...
.header .consult-btn:hover{background:#e06a15!important}

.db-page{padding:60px 0}
.db-wrap{max-width:900px;margin:0 auto;padding:0 24px}
...
.db-content h2{font-size:16px;font-weight:700;color:#1a1a26;margin:28px 0 10px}
.db-content p{font-size:13px;color:#555;line-height:1.7;margin:0 0 12px}
.db-content ul{margin:0 0 16px;padding:0 0 0 20px}
.db-content ul li{font-size:13px;color:#555;line-height:1.6;margin-bottom:4px}
...
<h1 class="db-section-title">Политика конфиденциальности</h1>
<div class="db-content">

<p>Настоящая Политика конфиденциальности персональных данных (далее — Политика) действует в отношении всей информации, которую ООО «Оборудование Кубани» (ОГРН 1082312000123, ИНН 2312132840, далее — Оператор) может получить о пользователе во время использования сайта ob-kub.ru.</p>
...
<p><strong>Обработка персональных данных</strong> — любое действие (операция) или совокупность действий с персональными данными, совершаемых с использованием средств автоматизации или без их использования.</p>
<p><strong>Субъект персональных данных</strong> — физическое лицо, которое заполнило форму на сайте, заказало расчёт, направило запрос через форму обратной связи.</p>
<p><strong>Cookie</strong> — небольшой фрагмент данных, отправленный веб-сервером и хранимый на устройстве пользователя.</p>
...
<li>Устав ООО «Оборудование Кубани»;</li>
<li>Настоящая Политика конфиденциальности;</li>
<li>Согласие субъекта на обработку персональных данных.</li>
</ul>

<h2>3. Объём и категории обрабатываемых персональных данных</h2>
<p><strong>3.1.</strong> Оператор может обрабатывать следующие персональные данные субъекта:</p>
<ul>
<li>Фамилия, имя, отчество;</li>
<li>Номер контактного телефона;</li>
<li>Адрес электронной почты;</li>
<li>Сведения о компании (наименование, ИНН — при заполнении коммерческих форм);</li>
<li>Текст сообщения, техническое задание, приложенные файлы.</li>
</ul>
<p><strong>3.2.</strong> Автоматически собираемые данные: IP-адрес, тип и версия браузера, операционная система, источник перехода, дата и время посещения, просмотренные страницы, cookie-файлы.</p>
<p><strong>3.3.</strong> Оператор не обрабатывает специальные категории персональных данных, касающиеся расовой, национальной принадлежности, политических взглядов, религиозных или философских убеждений, состояния здоровья, интимной жизни.</p>

<h2>4. Цели обработки персональных данных</h2>
<p>Оператор обрабатывает персональные данные в следующих целях:</p>
<ul>
<li>Консультирование по вопросам выбора и приобретения оборудования;</li>
<li>Подготовка коммерческого предложения и расчёта стоимости;</li>
<li>Заключение и исполнение договоров поставки;</li>
<li>Информирование о статусе заказа, сроках изготовления и отгрузки;</li>
<li>Направление информационных материалов (с согласия субъекта);</li>
<li>Улучшение качества сайта и пользовательского опыта;</li>
<li>Статистический анализ поведения пользователей.</li>
</ul>

<h2>5. Способы и сроки обработки персональных данных</h2>
<p><strong>5.1.</strong> Обработка персональных данных осуществляется с использованием средств автоматизации и без их использования.</p>
<p><strong>5.2.</strong> Срок обработки персональных данных определяется:</p>
<ul>
<li>Достижением целей обработки;</li>
<li>Сроком действия договора с субъектом;</li>
<li>Сроком исковой давности (3 года с момента последнего взаимодействия);</li>
<li>Требованиями законодательства РФ (в части обязательного хранения документов — 5 лет).</li>
</ul>
<p><strong>5.3.</strong> По истечении установленных сроков персональные данные уничтожаются или обезличиваются.</p>

<h2>6. Передача персональных данных третьим лицам</h2>
<p><strong>6.1.</strong> Оператор не передаёт персональные данные субъектов третьим лицам, за исключением:</p>
<ul>
<li>Случаев, когда субъект выразил согласие на такую передачу;</li>
<li>Передачи в рамках исполнения договора (транспортные компании — для доставки);</li>
<li>Запросов уполномоченных государственных органов в соответствии с законодательством РФ;</li>
<li>Иных случаев, предусмотренных законодательством РФ.</li>
</ul>
<p><strong>6.2.</strong> При передаче данных третьим лицам Оператор обеспечивает соблюдение конфиденциальности персональных данных.</p>
...
<p>Оператор принимает следующие организационные и технические меры:</p>
<ul>
<li>Назначение ответственного за организацию обработки персональных данных;</li>
<li>Издание внутренних документов по обработке персональных данных;</li>
<li>Ограничение физического доступа к носителям персональных данных;</li>
<li>Использование защищённых протоколов передачи данных (HTTPS);</li>
<li>Применение антивирусных средств и средств защиты от несанкционированного доступа;</li>
<li>Регулярный мониторинг и аудит информационной безопасности.</li>
</ul>

<h2>9. Заключительные положения</h2>
<p><strong>9.1.</strong> Настоящая Политика является общедоступной и подлежит размещению на сайте Оператора.</p>
<p><strong>9.2.</strong> Оператор имеет право вносить изменения в Политику в одностороннем порядке. Новая редакция вступает в силу с момента её размещения на сайте.</p>
<p><strong>9.3.</strong> Использование сайта после внесения изменений означает согласие с новой редакцией Политики.</p>
<p><strong>9.4.</strong> По всем вопросам, связанным с обработкой персональных данных, субъект может обратиться к Оператору:</p>
<ul>
<li>По телефону: <a href="tel:+79935940107">8 (993) 594-01-07</a></li>
<li>По электронной почте: <a href="mailto:oborudovanie-kubani@yandex.ru">oborudovanie-kubani@yandex.ru</a></li>
<li>Почтовым отправлением: 350051, г. Краснодар, ул. Дорожный переулок, 5</li>
</ul>

<h2>10. Реквизиты Оператора</h2>
<p>ООО «Оборудование Кубани»<br>
ОГРН: 1082312000123<br>
ИНН: 2312132840<br>
КПП: 231201001<br>
Юридический адрес: 350051, Краснодарский край, г. Краснодар, ул. Дорожный переулок, д. 5</p>
