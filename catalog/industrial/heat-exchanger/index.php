...
$schema = json_encode([
    ...
    'material' => 'Нержавеющая сталь AISI 304/316',
...
<link rel="canonical" href="https://ob-kub.ru/catalog/industrial/heat-exchanger/">
...
<div class="hero-price">от 80 000 ₽</div>
<div class="hero-hint">* Цена зависит от модели и материала</div>
</div>
...
<div class="pec-card"><div class="c-label">Материал</div><div class="c-value">AISI 304/316</div></div>
<div class="pec-card"><div class="c-label">Тип</div><div class="c-value">Пластинчатый / кожухотрубный</div></div>
<div class="pec-card"><div class="c-label">Давление</div><div class="c-value">до 10 <span class="c-unit">бар</span></div></div>
<div class="pec-card"><div class="c-label">Температура</div><div class="c-value">до 140 <span class="c-unit">°C</span></div></div>
<div class="pec-card"><div class="c-label">Мощность</div><div class="c-value">10–500 <span class="c-unit">кВт</span></div></div>
</div>
</div>
</section>
...
<p>Пластинчатые теплообменники состоят из набора гофрированных пластин из AISI 304/316, собранных в пакет на раме. Компактные, высокоэффективные, легко разбираются для мойки. Идеальны для работы с жидкими продуктами: молоко, сок, пиво, сиропы.</p>
<p>Кожухотрубные теплообменники применяются для вязких продуктов, с содержанием частиц, или в условиях высокого давления. Конструкция — пучок труб внутри цилиндрического корпуса.</p>
<h3 
...
<div class="faq-item">
<div class="faq-q" onclick="toggleFaq(this)">Чем отличается пластинчатый от кожухотрубного?<span class="faq-arrow">▼</span></div>
<div class="faq-a">Пластинчатый — компактный, высокоэффективный, легко разбирается для мойки. Подходит для чистых жидкостей. Кожухотрубный — более надёжный, работает с вязкими продуктами и при высоком давлении, но менее эффективен и сложнее в обслуживании.</div>
</div>
<div class="faq-item">
<div class="faq-q" onclick="toggleFaq(this)">Из каких материалов уплотнения?<span class="faq-arrow">▼</span></div>
<div class="faq-a">Стандартно — EPDM (пищевой, до 120°C). Для высоких температур (до 140°C) — NBR или Viton. Все материалы сертифицированы для контакта с пищевыми продуктами.</div>
</div>
<div class="faq-item">
<div class="faq-q" onclick="toggleFaq(this)">Как подбирается теплообменник?<span class="faq-arrow">▼</span></div>
<div class="faq-a">По параметрам: тип продукта, температура на входе/выходе, расход, допустимые потери давления, тип теплоносителя (пар, горячая вода, гликоль). На основе этих данных рассчитывается количество пластин/площадь поверхности.</div>
</div>
<div class="faq-item">
<div class="faq-q" onclick="toggleFaq(this)">Какие сроки изготовления?<span class="faq-arrow">▼</span></div>
<div class="faq-a">Стандартные теплообменники — от 3-5 рабочих дней. Нестандартные (расчётные) — от 7-10 дней.</div>
</div>
</div>
</div>
</section>
...
<div class="form-ub">Оставьте заявку — мы подберём теплообменник под ваши параметры и пришлём КП</div>
<form method="post" class="quick-form" action="/php/send.php">
<input type="hidden" name="form_type" value="industrial-heat-exchanger">
<input type="hidden" name="product" value="Теплообменник промышленный">
...
<input type="text" name="quantity_display" placeholder="Тип: пластинчатый / кожухотрубный">
</div>
<div class="form-row">
<textarea name="comment" placeholder="Продукт, температура, расход, теплоноситель..."></textarea>
</div>
<div class="form-row">
