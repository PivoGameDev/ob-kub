...
<?php $cctArticles = [
['title' => 'Как выбрать ЦКТ для пивоварни', 'content' => ['<p>Цилиндро-конический танк — сердце любой пивоварни. Именно в ЦКТ сусло превращается в пиво: бродит, дображивает, созревает и насыщается углекислотой. От правильного выбора ЦКТ зависит не только качество пива, но и эффективность всего производства.</p>','<h3>Главные параметры выбора</h3><p><strong>Объём.</strong> ЦКТ подбирается под сменную партию: рабочий объём танка должен быть на 20–30% больше объёма одной варки.</p><p><strong>Угол конуса.</strong> Оптимальный угол — 60–75°. Чем круче конус, тем эффективнее сбор дрожжей.</p><p><strong>Рубашки охлаждения.</strong> Для ЦКТ до 5000 л достаточно 2 зон охлаждения. Для танков большего объёма нужны 3–4 зоны.</p><p><strong>Рабочее давление.</strong> Стандарт для пивоваренных ЦКТ — 2,5 бар. Все наши ЦКТ рассчитаны на 2,5 бар с запасом прочности.</p><h3>Сколько нужно ЦКТ</h3><p>Минимальная формула: количество сортов × 2. Для пивоварни с 3 сортами пива нужно минимум 6 ЦКТ.</p>','<p>Не знаете, какой ЦКТ подойдёт? Инженер подберёт оптимальный объём под вашу варку и подготовит КП.</p>']],
['title' => 'Сколько нужно ЦКТ: формула для пивоварни', 'content' => ['<p>Количество ЦКТ — один из главных вопросов при проектировании пивоварни. Оптимальное количество рассчитывается исходя из сортовой матрицы, цикла брожения и графика варок.</p>','<h3>Базовая формула</h3><p><strong>N = S × (C / D + 1)</strong>, где S — количество сортов, C — полный цикл ЦКТ в днях, D — периодичность варок. Плюс один резервный танк на сорт.</p><p>Пример: пивоварня варит 3 сорта. При варке каждого раз в неделю потребуется 7 ЦКТ.</p>','<p>«ОБОРУДОВАНИЕ КУБАНИ» помогает рассчитать конфигурацию ЦКТ под план производства.</p>']],
['title' => 'Как разобраться в названиях: ЦКТ, танк брожения, форфас', 'content' => ['<p>В пивоварении одно и то же оборудование могут называть по-разному. ЦКТ также называют конусным танком, танком брожения или танком дображивания.</p>','<p><strong>Основные синонимы:</strong></p><p>• ЦКТ = цилиндроконический танк = танк брожения</p><p>• Форфас = лагерный танк = юнит = BBT</p><p>• Заторный аппарат = маш тюн</p><p>• Сусловарочный аппарат = варочный котел</p><p>• Бак горячей воды = БГВ</p>','<p>Всё оборудование производится из нержавеющей стали AISI 304/316.</p>']],
]; ?>
...
<div style="font-size:12px;text-transform:uppercase;letter-spacing:1px;color:#F77C2A;font-weight:600">Полезные материалы</div>
</div>
