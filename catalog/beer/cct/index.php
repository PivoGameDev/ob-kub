...
<div style="margin:0 28px 24px;border-radius:10px;overflow:hidden;position:relative;min-height:240px">
...
<div style="position:relative;z-index:2;display:flex;flex-direction:column;justify-content:flex-end;min-height:240px;padding:24px">
