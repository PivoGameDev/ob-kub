...
<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center;max-width:700px;margin:0 auto">
<?php foreach ($volumes as $v): ?>
<a href="/catalog/beer/cct/volume.php?vol=<?= $v ?>" style="display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;background:rgba(247,124,42,.1);border:1px solid rgba(247,124,42,.2);border-radius:8px;font-size:14px;font-weight:700;color:#F77C2A;text-decoration:none;transition:all .2s;min-width:70px" onmouseover="this.style.background='#F77C2A';this.style.color='#fff';this.style.borderColor='#F77C2A'" onmouseout="this.style.background='';this.style.color='';this.style.borderColor=''"><?= number_format($v, 0, '.', ' ') ?> л</a>
<?php endforeach; ?>
</div>
</div>
