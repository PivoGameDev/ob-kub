...
$canonical = 'https://ob-kub.ru/catalog/wine/';
...
$categories = [
    ['key' => 'red-fermentation', 'emoji' => '🍷'],
    ['key' => 'white-fermentation', 'emoji' => '🥂'],
    ['key' => 'storage-aging', 'emoji' => '🏺'],
    ['key' => 'cold-stabilization', 'emoji' => '❄️'],
    ['key' => 'blending', 'emoji' => '🥃'],
    ['key' => 'sulfitation', 'emoji' => '🧪'],
    ['key' => 'universal-tank', 'emoji' => '🔄'],
];
$h1 = $wineCategory['h1'];
$metaTitle = $wineCategory['title'];
$metaDesc = $wineCategory['desc'];
...
<span class="current">Винодельческое оборудование</span>
</div>
<div class="hero-text">
...
?>
<a href="/catalog/wine/<?= $c['key'] ?>/" class="cat-card">
...
<div class="cat-count"><?= $volCount ?> объёмов: <?= $minVol ?> – <?= number_format($maxVol, 0, '.', ' ') ?> л</div>
</div>
