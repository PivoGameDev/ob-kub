...
<title>Сертификаты — ОБОРУДОВАНИЕ КУБАНИ</title>
<meta name="description" content="Сертификаты соответствия на оборудование из нержавеющей стали. ТР ЕАЭС, декларации, паспорта сосудов под давлением.">
<link rel="canonical" href="https://ob-kub.ru/certificates.html">
...
.cert-item{display:flex;gap:24px;background:#fff;border-radius:14px;padding:24px;box-shadow:0 4px 20px rgba(0,0,0,.07);border:1px solid #eee;margin-bottom:16px;align-items:flex-start}
.cert-item .cert-icon{flex-shrink:0;width:56px;height:56px;background:rgba(247,124,42,.1);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:24px}
.cert-item .cert-text{flex:1}
.cert-item h3{font-size:15px;font-weight:700;color:#1a1a26;margin:0 0 6px}
.cert-item p{font-size:13px;color:#555;line-height:1.6;margin:0}
...
.cert-files{margin-top:20px}
.cert-downloads{display:grid;grid-template-columns:repeat(2,1fr);gap:16px;max-width:800px;margin:0 auto}
.cert-dl-card{display:flex;gap:16px;background:#fff;border-radius:14px;padding:20px;box-shadow:0 4px 20px rgba(0,0,0,.07);border:1px solid #eee;align-items:center}
.cert-dl-icon{flex-shrink:0;font-size:32px}
.cert-dl-info{flex:1;min-width:0}
.cert-dl-info h3{font-size:14px;font-weight:700;color:#1a1a26;margin:0 0 4px}
.cert-dl-info p{font-size:12px;color:#555;line-height:1.5;margin:0}
.cert-dl-btn{display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#F77C2A,#e06a15);color:#fff;border:none;border-radius:8px;padding:8px 18px;font-size:13px;font-weight:600;cursor:pointer;text-decoration:none;transition:opacity .2s;white-space:nowrap}
.cert-dl-btn:hover{opacity:.9;color:#fff}
@media(max-width:768px){.cert-downloads{grid-template-columns:1fr}}
...
<h1 class="db-section-title">Сертификаты и разрешения</h1>
<p class="db-section-sub">Вся продукция сертифицирована и соответствует требованиям Таможенного союза</p>

<div class="cert-list">
<div class="cert-item">
<div class="cert-icon">📄</div>
<div class="cert-text">
<h3>Декларация соответствия ТР ЕАЭС</h3>
<p>Наше оборудование для пищевой промышленности имеет декларацию соответствия требованиям Технического регламента Евразийского экономического союза «О безопасности пищевой продукции».</p>
</div>
</div>
<div class="cert-item">
<div class="cert-icon">🔧</div>
<div class="cert-text">
<h3>Сосуды под давлением (ТР ЕАЭС 032/2013)</h3>
<p>Ёмкости, работающие под избыточным давлением, изготавливаются с соблюдением требований ТР ЕАЭС 032/2013, проходят гидроиспытания и регистрируются в Ростехнадзоре.</p>
</div>
</div>
<div class="cert-item">
<div class="cert-icon">🗺️</div>
<div class="cert-text">
<h3>Паспорт оборудования и руководство по эксплуатации</h3>
<p>Каждое изделие сопровождается паспортом, руководством по эксплуатации, чертежами общего вида и схемой подключения.</p>
</div>
</div>
<div class="cert-item">
<div class="cert-icon">🔬</div>
<div class="cert-text">
<h3>Протоколы испытаний сварных швов</h3>
<p>Все сварные соединения проходят визуальный и измерительный контроль, 100% гидроиспытания. По запросу — УЗК или рентген-контроль.</p>
</div>
</div>
<div class="cert-item">
<div class="cert-icon">🥇</div>
<div class="cert-text">
<h3>Сертификаты на материалы AISI 304/316</h3>
<p>Предоставляем сертификаты качества на поставляемую нержавеющую сталь от ведущих мировых производителей (Pozzi Leopoldo, Outokumpu, Aperam).</p>
</div>
</div>
</div>
<div class="cert-files">
<h2 style="font-size:18px;font-weight:700;color:#1a1a26;margin:40px 0 20px;text-align:center">Наши сертификаты</h2>
<div class="cert-downloads">
<div class="cert-dl-card">
<div class="cert-dl-icon">📄</div>
<div class="cert-dl-info">
<h3>Декларация соответствия ТР ЕАЭС</h3>
<p>Декларация о соответствии оборудования требованиям технического регламента Евразийского экономического союза.</p>
</div>
<div class="cert-dl-actions">
<a href="/cert-declaration.docx" class="cert-dl-btn" download>Скачать</a>
</div>
</div>
<div class="cert-dl-card">
<div class="cert-dl-icon">📜</div>
<div class="cert-dl-info">
<h3>Сертификат качества 2024–2026</h3>
<p>Сертификат соответствия системы менеджмента качества производства ёмкостного оборудования.</p>
</div>
<div class="cert-dl-actions">
<a href="/cert-quality.docx" class="cert-dl-btn" download>Скачать</a>
</div>
</div>
</div>
</div>
