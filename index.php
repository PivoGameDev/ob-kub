...
<title>ОБОРУДОВАНИЕ КУБАНИ — производитель оборудования из нержавеющей стали</title>
    <link rel="canonical" href="https://ob-kub.ru/">
<meta name="description" content="ООО «Оборудование Кубани» — производитель емкостного оборудования из нержавеющей стали AISI 304/316. Пивоварни, молочное и винодельческое оборудование. Доставка по РФ.">
...
/* ===== HEADER — WHITE ===== */
.header{position:relative!important;background:#fff!important;border-bottom:none!important;padding:0!important;min-height:64px!important;display:flex!important;align-items:center!important;box-shadow:0 1px 4px rgba(0,0,0,.08)!important}
...
.header .logo-img{height:67px!important;width:auto!important;padding:0!important;margin:0!important;display:block!important}
...
.nav>a:hover,.cat-trigger:hover,.search-trigger:hover{color:#F77C2A!important;background:transparent!important}
...
.catalog-overlay-body{display:grid;grid-template-columns:1fr 1fr;gap:6px 16px}
}
...
.db-hero-tags a{display:inline-flex;padding:8px 16px;background:rgba(247,124,42,.1);border:1px solid rgba(247,124,42,.2);border-radius:6px;font-size:12px;font-weight:600;color:#F77C2A;text-decoration:none;transition:opacity .5s ease,transform .5s ease,background .2s;opacity:0;transform:translateY(14px)}
.db-hero-tags a.visible{opacity:1;transform:translateY(0)}
.db-hero-tags a:hover{background:rgba(247,124,42,.2)}
...
.cat-card{background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,.06);transition:transform .2s,box-shadow .2s;text-decoration:none;color:inherit;display:flex;flex-direction:column;border:1px solid #eee;overflow:hidden;position:relative}
.cat-card-texture{position:absolute;top:0;left:0;width:100%;height:100%;z-index:3;pointer-events:none;will-change:transform;transition:transform .7s ease-out}
.cat-card[data-texture="beer"] .cat-card-texture{background:url(textures/beer-texture.jpg) center/cover no-repeat}
.cat-card[data-texture="dairy"] .cat-card-texture{background:url(textures/dairy-texture.jpg) center/cover no-repeat}
.cat-card[data-texture="wine"] .cat-card-texture{background:url(textures/wine-texture.jpg) center/cover no-repeat}
.cat-card[data-texture="oil"] .cat-card-texture{background:url(textures/oil-texture.jpg) center/cover no-repeat}
.cat-card:hover{transform:translateY(-6px);box-shadow:0 12px 36px rgba(247,124,42,.15);border-color:#fde0c0}
.cat-card-img{width:100%;height:200px;overflow:hidden;background:#fff;display:flex;align-items:center;justify-content:center}
.cat-card-img img{max-width:100%;max-height:100%;display:block}
.cat-card-body{padding:20px 24px 20px;flex:1;display:flex;flex-direction:column;text-align:center}
.cat-card-body .cat-name{font-size:18px;font-weight:700;color:#1a1a26;margin-bottom:8px;line-height:1.3}
.cat-card-body .cat-desc{font-size:13px;color:#666;line-height:1.6;flex:1}
.cat-card-body .cat-count{font-size:12px;color:#F77C2A;font-weight:600;margin-top:12px}
.cat-card-footer{padding:0 24px 24px}
.cat-card-footer .btn-view{display:block;width:100%;padding:14px;background:#F77C2A;color:#fff;border:none;border-radius:8px;font-size:15px;font-weight:700;cursor:pointer;text-decoration:none;text-align:center;transition:background .2s}
.cat-card-footer .btn-view:hover{background:#e06a1a}
...
.db-row-img img{width:100%;border-radius:12px;display:block}
.db-row-text p{font-size:14px;color:#555;line-height:1.7;margin:0 0 20px}
...
.db-weld-inner h3{font-size:22px;font-weight:800;color:#fff;margin:0 0 10px;text-transform:uppercase;letter-spacing:.4px}
...
.db-weld-badge.ok{background:rgba(46,204,113,.12);border-color:rgba(46,204,113,.2);color:#2ecc71}
.db-weld-img{display:flex;align-items:center;justify-content:center}
.db-weld-img img{width:100%;max-width:420px;border-radius:10px;display:block;box-shadow:0 6px 24px rgba(0,0,0,.35);clip-path:polygon(0 0,100% 0,100% calc(100% - 6px),calc(100% - 6px) 100%,0 100%)}
...
/* ===== SEO TEXT ===== */
.db-seo-wrap{max-width:820px;margin:0 auto}
.db-seo-text{font-size:14px;color:#555;line-height:1.8;max-height:100px;overflow:hidden;transition:max-height .5s ease;position:relative}
.db-seo-text.expanded{max-height:none}
.db-seo-text p{margin:0 0 12px}
.db-seo-toggle{display:inline-flex;align-items:center;gap:6px;margin-top:12px;padding:10px 24px;background:#fff;border:2px solid #e2e8f0;border-radius:8px;font-size:13px;font-weight:600;color:#2b2b39;cursor:pointer;transition:all .25s}
.db-seo-toggle:hover{border-color:#F77C2A;color:#F77C2A}
...
/* ===== CONTACTS ===== */
.db-contacts{display:grid;grid-template-columns:1fr 1fr;gap:40px}
.db-contact-item{display:flex;gap:14px;margin-bottom:20px}
.db-contact-item svg{width:22px;height:22px;flex-shrink:0;color:#F77C2A;margin-top:2px}
.db-contact-item h4{font-size:13px;font-weight:700;color:#1a1a26;margin:0 0 3px}
.db-contact-item p{font-size:14px;color:#555;margin:0;line-height:1.5}
.db-contact-item a{color:#333;text-decoration:none;transition:color .2s}
.db-contact-item a:hover{color:#F77C2A}
.db-contact-map iframe{width:100%;height:320px;border-radius:14px;border:none;display:block}
...
.db-hero h1{font-size:36px}
.db-hero-inner{padding:60px 24px 50px}
.db-section-title{font-size:22px}
.db-aisi-grid h2{font-size:20px}
.db-aisi-grid,.db-prod-grid{grid-template-columns:1fr;gap:24px}
.db-row-inner{grid-template-columns:1fr;gap:20px}
.db-row-inner.rev{direction:ltr}
.cat-grid{grid-template-columns:repeat(3,1fr);gap:16px}
.db-aisi-grid .aisi-gallery img{display:block;margin:0 auto;max-width:100%;height:auto}
.db-row-img img{display:block;margin:0 auto;max-width:33%}
.db-prod-grid img{display:block;margin:0 auto;max-width:90%}
.db-prod-equip{grid-template-columns:repeat(3,1fr)}
...
.nav{order:3!important;width:100%!important;display:flex!important;flex-wrap:wrap!important;justify-content:center!important;gap:2px 8px!important;padding:0!important;margin-top:-10px!important}
.nav>a,.cat-trigger,.search-trigger{font-size:12px!important;padding:0!important;line-height:1!important}
...
.db-row-text p{font-size:13px;line-height:1.6;color:#555}
.db-seo-text{font-size:13px;line-height:1.7}
...
.db-arm-gallery{gap:8px}
.db-row-section{padding:32px 0}
.db-contacts{grid-template-columns:1fr}
.db-project-card{flex:0 0 260px}
.db-project-card img{height:160px}
.db-form-row{grid-template-columns:1fr}
.db-footer-inner{grid-template-columns:repeat(3,1fr);gap:16px}
.db-prod-stats{gap:16px}
.db-prod-stat .num{font-size:28px}
.db-prod-equip{grid-template-columns:repeat(2,1fr)}
.db-prod-equip-card .eq-img{height:140px!important;padding:12px!important}
.db-prod-equip-card .eq-body{padding:8px 10px 10px!important}
.db-prod-equip-card .eq-name{font-size:12px!important;margin-bottom:2px!important}
.db-prod-equip-card .eq-spec{font-size:11px!important}
.db-weld-inner{grid-template-columns:1fr!important;gap:16px!important;text-align:left!important}
...
.db-row-img img{max-width:43%}
.db-row-text p{font-size:12px}
.db-seo-text{font-size:12px}
...
.db-prod-stats{flex-direction:column;gap:14px}
.db-prod-equip-card .eq-img{height:120px!important;padding:8px!important}
...
<style>
.prods2 a{flex:0 0 auto;width:140px;text-decoration:none;color:inherit}
.prods2 div{background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.06)}
.prods2::-webkit-scrollbar{height:4px}
.prods2::-webkit-scrollbar-thumb{background:rgba(255,255,255,.2);border-radius:2px}
.prods2 img{width:100%;height:100px;object-fit:contain;display:block;background:#fff;padding:8px}
.prods2 span{display:block;padding:6px 8px;font-size:11px;color:#333;font-weight:600;text-align:center;line-height:1.2;min-height:28px}
.prods2 .pr-btn{display:block;padding:5px 8px;font-size:10px;color:#F77C2A;font-weight:700;text-align:center;border-top:1px solid #eee;text-decoration:none}
</style>

<script>
(function(){
var D = [
  {img:"banner-dairy.jpg",title:"🥛 Молочное",sub:"Оборудование для молочной промышленности",vol:"500 – 200 000 л",price:"от 195 000 ₽",desc:"Оборудование для молочной промышленности: ёмкости приёмки и хранения, резервуары-охладители, ВДП, ферментационные танки, сыро- и творогоизготовители.",pd:'<a href="/catalog/dairy/reception/"><div><img src="dairy-reception.jpg"><span>Ёмкость приёмки молока</span><span class="pr-btn">Цена от 195 000 ₽ →</span></div></a><a href="/catalog/dairy/storage/"><div><img src="dairy-storage.jpg"><span>Резервуар хранения молока</span><span class="pr-btn">Цена от 367 000 ₽ →</span></div></a><a href="/catalog/dairy/cooler/"><div><img src="dairy-cooler.jpg"><span>Резервуар-охладитель</span><span class="pr-btn">Цена от 250 000 ₽ →</span></div></a><a href="/catalog/dairy/vdp/"><div><img src="dairy-vdp.jpg"><span>Ванна пастеризации ВДП</span><span class="pr-btn">Цена от 345 000 ₽ →</span></div></a><a href="/catalog/dairy/fermentation/"><div><img src="dairy-fermentation.jpg"><span>Ферментационный танк</span><span class="pr-btn">Цена от 247 000 ₽ →</span></div></a><a href="/catalog/dairy/cheese-maker/"><div><img src="dairy-cheese-maker.jpg"><span>Сыроизготовитель</span><span class="pr-btn">Цена от 306 000 ₽ →</span></div></a><a href="/catalog/dairy/cottage-cheese/"><div><img src="dairy-cottage-cheese.jpg"><span>Творогоизготовитель</span><span class="pr-btn">Цена от 350 000 ₽ →</span></div></a><a href="/catalog/dairy/yeast/"><div><img src="dairy-yeast.jpg"><span>Заквасочник</span><span class="pr-btn">Цена от 150 000 ₽ →</span></div></a>'},
  {img:"banner-wine.jpg",title:"🍷 Винодельческое",sub:"Оборудование для виноделия",vol:"500 – 50 000 л",price:"от 280 000 ₽",desc:"Винодельческое оборудование: ферментационные танки для красных и белых вин, ёмкости выдержки и хранения, криостабилизация, купажирование, сульфитация, винификаторы.",pd:'<a href="/catalog/wine/red-fermentation/"><div><img src="wine-red-fermentation.jpg"><span>Ферментация красных вин</span><span class="pr-btn">Цена от 280 000 ₽ →</span></div></a><a href="/catalog/wine/white-fermentation/"><div><img src="wine-white-fermentation.jpg"><span>Ферментация белых вин</span><span class="pr-btn">Цена от 300 000 ₽ →</span></div></a><a href="/catalog/wine/storage-aging/"><div><img src="wine-storage-aging.jpg"><span>Выдержка и хранение вина</span><span class="pr-btn">Цена от 350 000 ₽ →</span></div></a><a href="/catalog/wine/cold-stabilization/"><div><img src="wine-cold-stabilization.jpg"><span>Танк криостабилизации</span><span class="pr-btn">Цена от 350 000 ₽ →</span></div></a><a href="/catalog/wine/blending/"><div><img src="wine-blending.png"><span>Ёмкость для купажирования</span><span class="pr-btn">Цена от 450 000 ₽ →</span></div></a><a href="/catalog/wine/sulfitation/"><div><img src="wine-sulfitation.jpg"><span>Ёмкость сульфитации</span><span class="pr-btn">Цена от 200 000 ₽ →</span></div></a><a href="/catalog/wine/universal-tank/"><div><img src="wine-universal-tank.jpg"><span>Винификатор УТТ</span><span class="pr-btn">Цена от 380 000 ₽ →</span></div></a>'},
  {img:"banner-beer.jpg",title:"🍺 Пивоваренное",sub:"Оборудование для пивоварен",vol:"100 – 200 000 л",price:"от 94 000 ₽",desc:"Полный цикл пивоваренного оборудования: ЦКТ, варочные порядки, дробилки, БГВ, парогенераторы, чиллеры, форфасы, теплообменники.",pd:'<a href="/catalog/beer/cct/"><div><img src="cct-tank.jpg"><span>ЦКТ для брожения</span><span class="pr-btn">Цена от 94 000 ₽ →</span></div></a><a href="/catalog/beer/brew-house/"><div><img src="brew-kettle.jpg"><span>Варочный порядок</span><span class="pr-btn">Цена от 273 000 ₽ →</span></div></a><a href="/catalog/beer/hot-water-tank/"><div><img src="beer-hot-water-tank.jpg"><span>Бак горячей воды</span><span class="pr-btn">Цена от 150 000 ₽ →</span></div></a><a href="/catalog/beer/unitank/"><div><img src="unitank.jpg"><span>Форфас (BBT)</span><span class="pr-btn">Цена от 111 000 ₽ →</span></div></a><a href="/catalog/beer/chiller/"><div><img src="chiller.jpg"><span>Чиллер</span><span class="pr-btn">Цена от 80 000 ₽ →</span></div></a><a href="/catalog/beer/steam-generator/"><div><img src="steam-generator.jpg"><span>Парогенератор</span><span class="pr-btn">Цена от 90 000 ₽ →</span></div></a><a href="/catalog/beer/heat-exchanger/"><div><img src="heat-exchanger.jpg"><span>Теплообменник</span><span class="pr-btn">Цена от 60 000 ₽ →</span></div></a>'},
  {img:"banner-water.jpg",title:"💧 Для воды",sub:"Баки горячей воды и резервуары хранения",vol:"250 – 50 000 л",price:"от 150 000 ₽",desc:"Резервуары для воды из AISI 304/316: баки горячей воды, ёмкости для хранения.",pd:'<a href="/catalog/beer/hot-water-tank/"><div><img src="hot-water-tank.jpg"><span>Бак горячей воды</span><span class="pr-btn">Цена от 150 000 ₽ →</span></div></a>'},
  {img:"banner-oil.jpg",title:"🫒 Для масла",sub:"Ёмкости для пищевых масел",vol:"500 – 50 000 л",price:"от 220 000 ₽",desc:"Ёмкости для пищевых масел и жиров: резервуары хранения, ёмкости с мешалкой.",pd:'<a href="/catalog/industrial/mixing/"><div><img src="industrial-mixing.jpg"><span>Ёмкость с мешалкой</span><span class="pr-btn">Цена от 224 000 ₽ →</span></div></a><a href="/catalog/industrial/storage/"><div><img src="industrial-storage.jpg"><span>Резервуар хранения</span><span class="pr-btn">Цена от 144 000 ₽ →</span></div></a>'},
  {img:"banner-conf.jpg",title:"🍯 Кондитерская",sub:"Ёмкости для глазурей и сиропов",vol:"500 – 20 000 л",price:"от 200 000 ₽",desc:"Ёмкости с мешалкой для глазурей, сиропов, кондитерских масс.",pd:'<a href="/catalog/industrial/mixing/"><div><img src="industrial-mixing.jpg"><span>Ёмкость с мешалкой</span><span class="pr-btn">Цена от 200 000 ₽ →</span></div></a>'}
];
var cur=-1;
function sw(i){
  if(i===cur)return;
...
<div class="db-wrap">
<div class="db-section-line"></div>
<h2 class="db-section-title">Контакты</h2>
<p class="db-section-sub">Свяжитесь с нами любым удобным способом</p>
<div class="db-contacts">
<div>
<div class="db-contact-item">
<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
<div><h4>Адрес</h4><p>Дорожный переулок, 5, посёлок Индустриальный, городской округ Краснодар</p></div>
</div>
<div class="db-contact-item">
<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
<div><h4>Email</h4><p>oborudovanie-kubani@yandex.ru</p></div>
</div>
<div class="db-contact-item">
<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
<div><h4>Телефоны</h4><p><a href="tel:+79935940107">8 (993) 594-01-07</a> — бесплатный звонок<br><a href="tel:+79935940107">8 (993) 594-01-07</a></p></div>
</div>
<div class="db-contact-item">
...
<div><h4>Telegram</h4><p><a href="https://t.me/oborudovanie_kubani" target="_blank">@oborudovanie_kubani</a></p></div>
</div>
</div>
...
<script>
(function(){
var hero = document.querySelector('.db-hero');
var bg = hero ? hero.querySelector('.db-hero-bg') : null;
if (!hero || !bg) return;
var ticking = false;
function update() {
var rect = hero.getBoundingClientRect();
var viewH = window.innerHeight;
var scrolled = -rect.top / rect.height;
if (scrolled < 0) scrolled = 0;
if (scrolled > 1) scrolled = 1;
var maxMove = rect.height * 0.35;
bg.style.transform = 'translateY(' + (scrolled * maxMove) + 'px)';
ticking = false;
}
...
<script>
(function(){
var cards = document.querySelectorAll('.cat-card[data-texture]');
if (!cards.length) return;
var ticking = false;
function update(){
var viewH = window.innerHeight;
cards.forEach(function(card, idx){
var tex = card.querySelector('.cat-card-texture');
if (!tex) return;
var r = card.getBoundingClientRect();
var h = r.height;
var target = 0;
if (r.bottom > 0 && r.top < viewH) {
var offset = idx * viewH * 0.04;
var entryStart = viewH - h + offset;
var entryEnd = viewH * 0.3 + offset;
var pos = r.top;
if (entryStart > entryEnd) {
target = Math.max(0, Math.min(1, (entryStart - pos) / (entryStart - entryEnd)));
} else {
target = 1;
}
var exitStart = -h * 0.3 + offset;
var exitEnd = -h * 0.8 + offset;
var exit = Math.max(0, Math.min(1, (pos - exitStart) / (exitEnd - exitStart)));
target = target * (1 - exit);
}
tex.style.transform = 'translateY(' + (target * h) + 'px)';
});
ticking = false;
}
