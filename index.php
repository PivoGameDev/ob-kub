...
/* ===== HERO ===== */
.db-hero{position:relative;width:100%;min-height:80vh;display:flex;align-items:stretch;overflow:hidden;background:#1a1a26}
...
.db-hero-inner{position:relative;z-index:2;max-width:1200px;margin:0 auto;padding:24px 24px 60px;width:100%;display:flex;align-items:flex-start;justify-content:space-between;gap:48px}
...
.mobile-header .mobile-logo-wrap img{height:55px;width:auto;display:block}
...
<div style="text-align:left"><div style="font-size:20px;font-weight:800;color:#F77C2A;line-height:1.1">+5000 м²</div><div style="font-size:10px;color:#999;text-transform:uppercase;letter-spacing:.5px">наш цех</div></div>
...
<span style="display:inline-flex;align-items:center;gap:4px;padding:5px 10px;background:rgba(247,124,42,.08);border:1px solid rgba(247,124,42,.18);border-radius:5px;font-size:11px;font-weight:600;color:#F77C2A">Лазерная сварка</span>
<span style="display:inline-flex;align-items:center;gap:4px;padding:5px 10px;background:rgba(247,124,42,.08);border:1px solid rgba(247,124,42,.18);border-radius:5px;font-size:11px;font-weight:600;color:#F77C2A">AISI 304/316</span>
</div>
</div>
</div>
</section>
...
<div style="width:40px;height:40px;border-radius:50%;background:#F77C2A;display:flex;align-items:center;justify-content:center;flex-shrink:0">
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7" class="cta-arrow"/></svg>
</div>
</div>
</div>
<style>.cta-arrow{display:block}@media(max-width:940px){.cta-arrow{transform:rotate(90deg);transform-origin:center}}</style>
</div>
...
if(!inp||!res)return;
var hqImgs={'cct':'cct-tank.jpg','hot-water-tank':'hot-water-tank.jpg','reception':'dairy-reception.jpg','storage':'dairy-storage.jpg','vdp':'dairy-vdp.jpg','fermentation':'dairy-fermentation.jpg','cheese-maker':'dairy-cheese-maker.jpg','universal-tank':'виниф.jpg','red-fermentation':'wine-red-fermentation.jpg','mixing':'industrial-mixing.jpg','thermal':'industrial-thermal.jpg','storage-aging':'wine-storage-aging.jpg','brew-house':'brew-kettle.jpg','chiller':'chiller.jpg','steam-generator':'steam-generator.jpg','unitank':'unitank.jpg','cooler':'dairy-cooler.jpg','cottage-cheese':'dairy-cottage-cheese.jpg','yeast':'dairy-yeast.jpg','white-fermentation':'wine-white-fermentation.jpg','cold-stabilization':'wine-cold-stabilization.jpg','blending':'wine-blending.png','sulfitation':'wine-sulfitation.jpg','mash-tun':'mash-tun.jpg','combined-kettle':'combined-kettle.jpg','lauter-tun':'lauter-tun.jpg','brew-kettle':'brew-kettle.jpg','whirlpool':'whirlpool.jpg','industrial-storage':'industrial-storage.jpg','cip':'industrial-cip.jpg','pressure':'industrial-pressure.jpg','beer-hot-water-tank':'beer-hot-water-tank.jpg'};
...
var D = [
  ...
  {img:"banner-wine.jpg",title:"🍷 Винодельческое",sub:"Оборудование для виноделия",vol:"500 – 50 000 л",price:"от 280 000 ₽",desc:"Винодельческое оборудование: ферментационные танки для красных и белых вин, ёмкости выдержки и хранения, криостабилизация, купажирование, сульфитация, винификаторы.",pd:'<a href="/catalog/wine/red-fermentation/"><div><img src="wine-red-fermentation.jpg"><span>Ферментация красных вин</span><span class="pr-btn">500 – 50 000 л →</span></div></a><a href="/catalog/wine/white-fermentation/"><div><img src="wine-white-fermentation.jpg"><span>Ферментация белых вин</span><span class="pr-btn">500 – 31 500 л →</span></div></a><a href="/catalog/wine/storage-aging/"><div><img src="wine-storage-aging.jpg"><span>Выдержка и хранение</span><span class="pr-btn">1 000 – 200 000 л →</span></div></a><a href="/catalog/wine/cold-stabilization/"><div><img src="wine-cold-stabilization.jpg"><span>Танк криостабилизации</span><span class="pr-btn">500 – 31 500 л →</span></div></a><a href="/catalog/wine/blending/"><div><img src="wine-blending.png"><span>Ёмкость для купажирования</span><span class="pr-btn">1 000 – 50 000 л →</span></div></a><a href="/catalog/wine/sulfitation/"><div><img src="wine-sulfitation.jpg"><span>Ёмкость сульфитации</span><span class="pr-btn">500 – 31 500 л →</span></div></a><a href="/catalog/wine/universal-tank/"><div><img src="виниф.jpg"><span>Винификатор УТТ</span><span class="pr-btn">500 – 50 000 л →</span></div></a>'},
...
<div><h4 style="color:#fff">Email</h4><p style="color:rgba(255,255,255,.6)">oborudovanie-kubani@yandex.ru</p></div>
</div>
<div class="db-contact-item">
