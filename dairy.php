...
<img src="dairy-main-image.png" alt="Молочное оборудование" class="db-hero-bg">
<div class="db-hero-overlay"></div>
<div class="db-hero-inner">
<div class="db-hero-label">Оборудование Кубани — с 2008 года</div>
<h1>Молочное оборудование из нержавеющей стали</h1>
<p>Резервуары для хранения молока, ферментационные танки, сыроизготовители — полный цикл оснащения молочных производств.</p>
<div class="db-hero-stats">
<div class="db-hero-stat"><div class="num">50+</div><div class="lbl">Молочных производств запущено</div></div>
...
<h2 class="db-section-title">Молочные производства, которые мы запустили</h2>
<p class="db-section-sub">Реализованные проекты для молочных заводов и сыроварен по всей России и СНГ</p>
...
<li>Ванны длительной пастеризации 2000 л × 3 шт.</li>
<li>CIP-мойка на 4 контура с программируемым циклом</li>
</ul>
<p><strong>Результат:</strong> увеличение производительности на 40%, сокращение потерь сырья на 15%, окупаемость 18 месяцев.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
<div class="db-project-card">
<img src="pasteurization-tanks.jpg" alt="Ёмкости для пастеризации" loading="lazy">
<div class="db-project-body">
...
<div class="db-project-details">
<p>Комплексное оснащение крафтовой сыроварни мощностью 2 тонны молока в смену. Все ёмкости из AISI 304 с зеркальной полировкой внутренней поверхности.</p>
<ul>
...
<li>Камеры созревания с климат-контролем</li>
</ul>
<p><strong>Результат:</strong> 6 сортов сыра, запуск за 8 недель, производительность 600 кг сыра в смену.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
<div class="db-project-card">
<img src="cheez-kont.jpg" alt="Стелажные системы для сыра" loading="lazy">
<div class="db-project-body">
...
<li>Протоколирование параметров созревания по каждой партии</li>
</ul>
<p><strong>Результат:</strong> стабильное качество сыра, снижение брака на 25%, срок созревания сокращён на 15%.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
<div class="db-project-card">
<img src="fermentation-tanks-milk.jpg" alt="Ферментационные танки" loading="lazy">
<div class="db-project-body">
<h3>Линия кисломолочных продуктов, Ростов-на-Дону</h3>
<div class="db-project-preview">
<ul><li>Производство кефира, йогурта, ряженки</li><li>Контроль кислотности (pH) и температуры</li><li>Мешалки для равномерного сквашивания</li></ul>
<button class="db-project-btn js-toggle-case">Читать кейс</button>
</div>
<div class="db-project-details">
<p>Автоматизированная линия производства кисломолочных продуктов с программируемыми режимами сквашивания. 4 сорта продукции на одной линии.</p>
<ul>
<li>Ферментационные танки 3000 л × 3 шт. с рубашкой и мешалкой</li>
<li>Ёмкости для сквашивания 2000 л × 2 шт.</li>
<li>Система подачи закваски с дозатором</li>
<li>Пластинчатый охладитель для готового продукта</li>
<li>ПЛК с рецептурным управлением (12 рецептов)</li>
</ul>
<p><strong>Результат:</strong> 4 вида продукции, 10 тонн/сутки, запуск за 6 недель, автоматизация 90% процессов.</p>
<button class="db-project-btn js-toggle-case">Свернуть</button>
</div>
</div>
</div>
...
<!-- FULL CATALOG -->
<section class="db-section" id="full-catalog">
<div class="db-wrap">
<div class="db-section-line"></div>
<h2 class="db-section-title">Полный каталог молочного оборудования</h2>
<p class="db-section-sub">7 основных типов оборудования для профессионального молочного производства. Все аппараты из пищевой нержавеющей стали AISI 304/316.</p>

<div class="cat-grid">
<a href="/catalog/dairy/reception/" class="cat-card">
<div class="cat-card-img"><img src="dairy-reception.jpg" alt="Приемно-охладительная емкость" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Емкость приемно-охладительная (ПОМ)</div>
<div class="cat-desc">Прием, буферизация и быстрое охлаждение сырого молока. Тройная лопастная мешалка, CIP-автомат. AISI 304.</div>
<div class="cat-count">11 объёмов — 500–300 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/storage/" class="cat-card">
<div class="cat-card-img"><img src="dairy-storage.jpg" alt="Резервуар хранения" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Резервуар хранения (холодный)</div>
<div class="cat-desc">Изотермическое хранение молока, сливок, сыворотки при +2...+6°C. Сэндвич-изоляция 80-150 мм, рубашка охлаждения.</div>
<div class="cat-count">11 объёмов — 500–300 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/cooler/" class="cat-card">
<div class="cat-card-img"><img src="dairy-cooler.jpg" alt="Резервуар-охладитель" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Резервуар-охладитель молока</div>
<div class="cat-desc">Быстрое охлаждение с +35°C до +4°C. Полная рубашка охлаждения, термоизоляция, автоматика.</div>
<div class="cat-count">8 объёмов — 1000–50 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/fermentation/" class="cat-card">
<div class="cat-card-img"><img src="dairy-fermentation.jpg" alt="Ферментационный танк" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Ферментационный танк</div>
<div class="cat-desc">Сквашивание, созревание и охлаждение йогурта, сметаны, кефира. Интегрированный pH-метр, автоматический сброс давления.</div>
<div class="cat-count">11 объёмов — 500–300 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/cheese-maker/" class="cat-card">
<div class="cat-card-img"><img src="dairy-cheese-maker.jpg" alt="Сыроизготовитель" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Сыроизготовитель универсальный</div>
<div class="cat-desc">Полный цикл сыроварения: свертывание, разрезка сгустка, вымешивание. Режущие лиры/ножи, пневмопресс. AISI 316L.</div>
<div class="cat-count">11 объёмов — 500–300 000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/cottage-cheese/" class="cat-card">
<div class="cat-card-img"><img src="dairy-cottage-cheese.jpg" alt="Творогоизготовитель" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Творогоизготовитель</div>
<div class="cat-desc">Производство творога классическим и раздельным способом. Двойная рубашка, мешалка, система отвода сыворотки.</div>
<div class="cat-count">8 объёмов — 200–6300 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/vdp/" class="cat-card">
<div class="cat-card-img"><img src="dairy-vdp.jpg" alt="Ванна длительной пастеризации" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Ванны длительной пастеризации (ВДП)</div>
<div class="cat-desc">Пастеризация 72-95°C с точностью ±0,5°C. Двухстенная конструкция, мешалка, термоизоляция.</div>
<div class="cat-count">7 объёмов — 200–5000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/yeast/" class="cat-card">
<div class="cat-card-img"><img src="dairy-yeast.jpg" alt="Заквасочник" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Заквасочники</div>
<div class="cat-desc">Приготовление и хранение производственных заквасок. Точный температурный контроль, рубашка, стерилизация.</div>
<div class="cat-count">7 объёмов — 50–1000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
<a href="/catalog/dairy/brine/" class="cat-card">
<div class="cat-card-img"><img src="dairy-brine.jpg" alt="Контейнер для соления сыра" loading="lazy"></div>
<div class="cat-card-body">
<div class="cat-name">Контейнеры для соления сыра</div>
<div class="cat-desc">Соление и хранение сырных головок в рассоле. Пищевой полипропилен/нержавейка, система рециркуляции рассола.</div>
<div class="cat-count">8 объёмов — 200–5000 л</div>
</div>
<div class="cat-card-footer"><span class="btn-view">Выбрать</span></div>
</a>
</div>
...
<p>На всё оборудование — официальная гарантия производителя. Сертификат ТР ЕАЭС, соответствие ХАССП и СанПиН.</p>
</div>
<div class="db-adv-card">
<div class="icon-wrap"><img src="icon-project.svg" alt="Индивидуальное проектирование"></div>
<h3>Индивидуальное проектирование</h3>
<p>Разрабатываем концепцию под вашу задачу, планировку цеха и бюджет. Любые нестандартные решения для молочного производства.</p>
</div>
<div class="db-adv-card">
...
<p class="db-section-sub">Ответы на основные вопросы о молочном оборудовании</p>
<div class="db-faq">
<div class="db-faq-item open">
<button class="db-faq-q" onclick="toggleFaq(this)">Какая сталь используется для молочных резервуаров?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Мы используем пищевую нержавеющую сталь AISI 304 и AISI 316. Для хранения молока и молочных продуктов достаточно AISI 304, для агрессивных сред (сыворотка, моющие растворы) рекомендуется AISI 316.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Какой объём резервуаров вы производите?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Изготавливаем резервуары объемом от 100 до 300 000 литров. Под заказ возможны емкости большего объема. Срок изготовления — от 3 до 8 недель.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Входит ли CIP-мойка в комплект?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>CIP-система может быть включена в комплект поставки. Мы проектируем автоматические станции безразборной мойки под ваше оборудование и планировку цеха.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Как заказать оборудование для молочного производства?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Заполните форму расчета на сайте, укажите требуемый объем, тип продукта и планировку цеха. Мы подготовим КП в течение 2 рабочих дней. Возможен выезд технолога на объект.</p></div>
</div>
<div class="db-faq-item">
<button class="db-faq-q" onclick="toggleFaq(this)">Есть ли термоизоляция у резервуаров?<span class="arr">▼</span></button>
<div class="db-faq-a"><p>Да, все резервуары могут комплектоваться теплоизоляцией из пенополиуретана толщиной 50-150 мм. Это позволяет сохранять температуру продукта до 24-72 часов без дополнительного охлаждения.</p></div>
</div>
</div>
</div>
</section>
...
<input type="hidden" name="csrf" id="csrfToken" value=""><input type="hidden" name="form_type" value="milk-draft">
...
<option value="reception" data-industry="dairy">Ёмкость приёмки молока (ПОМ)</option>
<option value="storage" data-industry="dairy" selected>Резервуар для хранения молока</option>
<option value="cheesemaker" data-industry="dairy">Сыроизготовитель</option>
<option value="fermentation" data-industry="dairy">Ферментационный танк</option>
<option value="pasteurizer" data-industry="dairy">Ванна пастеризации (ВДП)</option>
<option value="curd" data-industry="dairy">Творогоизготовитель</option>
<option value="shelf" data-industry="dairy">Стеллажная камера созревания</option>
</select>
</div>
...
<button type="button" class="db-vol-btn active" data-vol="10000" onclick="selectDraftVol(10000)">10 000</button>
<button type="button" class="db-vol-btn" data-vol="25000" onclick="selectDraftVol(25000)">25 000</button>
...
<input type="hidden" id="draft-volume" name="volume" value="10000">
</div>

<div class="db-price-block" id="draft-price-block">
<div class="db-price-label">Предварительная стоимость:</div>
<div class="db-price-value" id="draft-price-value">от 937 000 ₽</div>
...
<a href="/catalog/dairy/storage/" class="sbtn catalog-link-btn" id="draft-catalog-link" target="_blank" style="display:inline-block; margin-top:8px; text-align:center; text-decoration:none; background:transparent; border:2px solid rgba(247,124,42,.3); color:#F77C2A; padding:13px; border-radius:10px; font-size:14px; font-weight:600;">Смотреть в каталоге →</a>
</form>
</div>
</section>
...
var item=btn.closest('.db-faq-item');
...
dairy:{defaultPrices:{500:450000,1000:750000,3000:1800000,5000:2800000,10000:4800000,25000:10000000},types:[{value:'reception',label:'Ёмкость приёмки молока (ПОМ)',prices:{1000:195000,3000:460000,5000:684000,10000:1200000,25000:2500000}},{value:'storage',label:'Резервуар для хранения молока',prices:{3000:367000,5000:546000,10000:937000,25000:2000000}},{value:'cheesemaker',label:'Сыроизготовитель',prices:{500:306000,1000:525000,3000:1200000,5000:1800000,10000:3200000,25000:6500000}},{value:'fermentation',label:'Ферментационный танк',prices:{500:247000,1000:424000,3000:999000,5000:1500000,10000:2600000,25000:5400000}},{value:'pasteurizer',label:'Ванна пастеризации (ВДП)',prices:{500:345000,1000:593000,3000:1400000,5000:2100000,10000:3600000,25000:7500000}},{value:'curd',label:'Творогоизготовитель',prices:{500:350000,1000:600000,3000:1400000,5000:2200000,10000:3800000,25000:7800000}},{value:'shelf',label:'Стеллажная камера созревания'}]}
};
var catalogUrls={
...
function updateDraftPrice(){var i='dairy',pv=document.getElementById('draft-price-value'),ci=document.getElementById('draft-vol-custom'),hi=document.getElementById('draft-volume'),d=draftIndustryData[i];if(!d){pv.textContent='По запросу';return}var tv=document.getElementById('draft-type').value,to=null;for(var x=0;x<d.types.length;x++){if(d.types[x].value===tv){to=d.types[x];break}}var pr=(to&&to.prices)||d.defaultPrices;if(!pr){pv.textContent='По запросу';return}var v=parseInt(hi.value);if(ci.style.display!=='none'&&ci.value)v=parseInt(ci.value);if(!v||v<=0){pv.textContent='от '+pr[Object.keys(pr).map(Number).sort(function(a,b){return a-b})[0]].toLocaleString('ru-RU')+' ₽';return}var sv=Object.keys(pr).map(Number).sort(function(a,b){return a-b}),p=null;for(var x=0;x<sv.length;x++){if(v<=sv[x]){p=pr[sv[x]];break}}if(p===null){var mv=sv[sv.length-1];p=Math.round(pr[mv]*(v/mv))}pv.textContent='от '+Math.round(p).toLocaleString('ru-RU')+' ₽'}
function updateCatalogLink(){var t=document.getElementById('draft-type').value,l=document.getElementById('draft-catalog-link'),ind=catalogUrls.dairy;if(!t){l.style.display='none';return}l.href=ind[t]||ind._default;l.style.display='inline-block'}
function toggleOptional(){var s=document.getElementById('optSection'),t=document.getElementById('optTrigger'),o=document.getElementById('optSection').style.display;if(o==='none'){s.style.display='block';t.classList.add('open')}else{s.style.display='none';t.classList.remove('open')}}

</script>
<script>document.getElementById("csrfToken").value=btoa(String(Math.floor(Date.now()/1e3)));</script></body>
</html>
